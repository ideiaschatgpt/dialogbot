...
<head>
    ...
    <script disable-devtool-auto src='https://cdn.jsdelivr.net/npm/disable-devtool' url='https://pay.kiwify.com.br/MaddIZr'></script>
...
.chat-container {
	background: url('https://i.imgur.com/pVz0zeO.png');
	border-radius: 25px;
...
<div id="painel" style="background-color: #f5f5f5; border-radius: 10px; padding: 20px; text-align: center;">
    <h1 style="color: #333; font-size: 24px; margin-bottom: 20px;">DialogBot <a href="https://ideiaschatgpt.github.io/" target="_blank" class="linkcanal" style="color: #22b62e;"><strong>Ideias ChatGPT</strong></a></h1>
    ...
    <div style="margin-bottom: 10px;">
        ...
        <input type="text" id="imgfundo" placeholder="Coloque a URL da Imagem Aqui" value="https://i.imgur.com/sY6FWdO.jpg" style="padding: 5px; width: 400px;">
    </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title text-center mb-4">DialogBot</h3>
